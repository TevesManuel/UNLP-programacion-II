...
procedure imprimirAABEnPreOrden(a: arbol);
begin
    write(a^.dato, ' -');
    if ( a^.HI <> Nil ) then
        imprimirAABEnPreOrden(a^.HI);
    if ( a^.HD <> Nil ) then
        imprimirAABEnPreOrden(a^.HD);
end;

procedure imprimirAABEnOrden(a: arbol);
begin
    if ( a^.HI <> Nil ) then
        imprimirAABEnOrden(a^.HI);
    write(a^.dato, ' -');
    if ( a^.HD <> Nil ) then
        imprimirAABEnOrden(a^.HD);
end;

procedure imprimirAABEnPostOrden(a: arbol);
begin
    if ( a^.HI <> Nil ) then
        imprimirAABEnPostOrden(a^.HI);
    if ( a^.HD <> Nil ) then
        imprimirAABEnPostOrden(a^.HD);
    write(a^.dato, ' -');
end;
...
begin
    ...
    imprimirpornivel(a);
    writeln('imprimirAABEnPreOrden');
    imprimirAABEnPreOrden(a);
    writeln;
    writeln('imprimirAABEnOrden');
    imprimirAABEnOrden(a);
    writeln;
    writeln('imprimirAABEnPostOrden');
    imprimirAABEnPostOrden(a);
    writeln;
    readln;
end.
